                    ...
                    <tr className="hover:bg-gray-50">
                      <td className="px-6 py-4">
                        <div className="flex flex-col">
                          ...
                          <span className="text-sm text-gray-500">
                            {deviceToDelete.manufacturer}
                          </span>
                          <span className="text-xs text-gray-400">
                            SN: {deviceToDelete.serialNumber}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex flex-col gap-1">
                          <span className={getStatusBadgeClass(deviceToDelete.status)}>
                            {deviceToDelete.status}
                          </span>
                          <span className={getConditionBadgeClass(deviceToDelete.condition)}>
                            {deviceToDelete.condition}
                          </span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-gray-900">
                          {deviceToDelete.location.replace("_", " ")}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        {deviceToDelete.assignedUser ? (
                          <div className="flex flex-col">
                            <span className="font-medium">
                              {deviceToDelete.assignedUser.firstName}{" "}
                              {deviceToDelete.assignedUser.lastName}
                            </span>
                            <span className="text-sm text-gray-500">
                              {deviceToDelete.assignedUser.email}
                            </span>
                            <span className="text-xs text-gray-400">
                              {deviceToDelete.assignedUser.department}
                            </span>
                          </div>
                        ) : (
                          <span className="text-gray-400">
